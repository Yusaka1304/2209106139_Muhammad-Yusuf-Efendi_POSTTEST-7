        ...
        <div class="card">
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    //tampung data file yang akan di aploud
                    $name = $_FILES['foto']['name'];
                    $tmp_name = $_FILES['foto']['tmp_name'];

                    // proses aploud file
                    move_uploaded_file($tmp_name, '../aplouds/products/' . $name);
                    ...
                    if(!$run_query_insert){
                        echo 'Data gagal di simpan' . mysqli_error($conn);
                        exit();
                    }
    ...
    btnAdd.addEventListener("click", function(e){
        ...
        listItem.innerHTML = `
            <tr>
                ...
                <td align="center"><button type="button" class="btn" onclick="removeRow(this)"><i class="fa 
